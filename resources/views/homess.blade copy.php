...
<body>
    ...
    <header>
        ...
        <div class="iniciarr">
            ...
            {{-- <h1>Dashboard</h1> --}}
            {{-- <a href="loguearser" >INICIAR SESION</a> --}}

            {{-- <button class="button" id="form-open">INICIAR SESION</button> --}}
            <!-- <a href="/PRUEBAS/Login-y-registro-con-html-css-js-main/Login-y-registro-con-html-css-js-main/index.html"><button>INICIAR SESION</button></a> -->
        </div>
        ...
        <section class="home">
            <div class="form_container">
                ...
                <div>
                    <img src="/img/IMG HOME/login.png" src="{{ asset('img/IMG HOME/login.png') }}" alt="">
                </div>
                <div class="form login_form">
                    {{-- craaando la ruta para el formulario en fomr acction llama a la funsion --}}

                    <form action="{{ route('home.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf {{-- token o seguridad  --}}
                        {{-- @method('put') --}}
                        <h2>INICIAR SESION</h2>
                        <label for="form-label" class="input_box">
                            <input class="form-control" id="email" placeholder="Ingresa tu correo electrónico"
                        ...
                        {{-- <input type="text" id="email" placeholder="Ingresa tu correo electrónico" required class="form-control"> --}}
                        {{-- <i class="uil uil-envelope-alt email"></i> --}}
                        {{-- </div> --}}
                        {{-- <div class="input_box"> --}}
                        ...
                        <button class="button" id="iniciar-sesion" type="submit">INICIAR SESION</button>
                ...
                <div class="form signup_form">
                    <form action="#">
                        ...
                        <div class="login_signup">Tienes una cuenta? <a href="#" id="login">INICIAR
                                SESION</a></div>
                    </form>
                </div>
            </div>
